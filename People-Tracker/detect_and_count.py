#/*IMPLEMNTATION FOR WEBCAM/ python3 detect_and_count.py --weights /weights/yolov7x.pt --source 0 --no-trace
#/*FOR ONLY PERSONS IN WEBCAM/ python3 detect_and_count.py --weights /weights/yolov7x.pt --source 0 --no-trace --classes 0
...
def count(founded_classes,im0):
  ...
  global peopleCount
  peopleCount = founded_classes.get('person')
